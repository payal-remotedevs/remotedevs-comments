...
return [
    ...
    'columns' => [
        ...
        'newsuid' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:rd_comments/Resources/Private/Language/locallang_db.xlf:tx_rdcomments_domain_model_comment.newsuid',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'internal_type' => 'db',
        ...
        'username' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:rd_comments/Resources/Private/Language/locallang_db.xlf:tx_rdcomments_domain_model_comment.username',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'readOnly' => 1,
        ...
        'usermail' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:rd_comments/Resources/Private/Language/locallang_db.xlf:tx_rdcomments_domain_model_comment.usermail',
            'config' => [
                'type' => 'input',
                'size' => '30',
                'max' => '256',
                ...
                'wizards' => [
                    'link' => [
                        'type' => 'popup',
                        'title' => 'LLL:EXT:rd_comments/Resources/Private/Language/locallang_db.xlf:tx_rdcomments_domain_model_comment.linkTitle',
                        'icon' => 'link_popup.gif',
                        'module' => [
                            'name' => 'wizard_link',
                        ],
        ...
        'paramlink' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:rd_comments/Resources/Private/Language/locallang_db.xlf:tx_rdcomments_domain_model_comment.paramlink',
            'config' => [
                'type' => 'input',
                'size' => '30',
                'max' => '300',
        ...
        'crdate' => [
            'exclude' => 0,
            'label' => 'LLL:EXT:rd_comments/Resources/Private/Language/locallang_db.xlf:tx_rdcomments_domain_model_comment.crdate',
            'config' => [
                'type' => 'input',
                'size' => 12,
                'eval' => 'datetime',
        ...
        'childcomment' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:rd_comments/Resources/Private/Language/locallang_db.xlf:tx_rdcomments_domain_model_comment.childcomment',
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_rdcomments_domain_model_comment',
                'foreign_field' => 'comment',
        ...
        'terms' => [
            'exclude' => 0,
            'label' => 'LLL:EXT:rd_comments/Resources/Private/Language/locallang_db.xlf:tx_rdcomments_domain_model_comment.terms',
            'config' => [
                'type' => 'check',
                'readOnly' => 1,
            ],
        ...
        'parent' => [
            'exclude' => true,
            'label' => 'LLL:EXT:rd_comments/Resources/Private/Language/locallang_db.xlf:tx_rdcomments_domain_model_comment.ParentComment',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'foreign_table' => 'tx_rdcomments_domain_model_comment',
                'foreign_table_where' => 'AND tx_rdcomments_domain_model_comment.pid=###CURRENT_PID###',
                'default' => 0,
            ],
        ],
    ],
